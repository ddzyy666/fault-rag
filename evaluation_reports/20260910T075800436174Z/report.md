...
| --- | --- | --- | --- | --- | --- | --- | --- |
| development | vector | 0.950 | 0.950 | 0.817 | 0.851 | 3.85 | 0/20 |
| development | hybrid_rrf | 1.000 | 1.000 | 0.895 | 0.920 | 10.7 | 0/20 |
| validation | vector | 0.800 | 0.800 | 0.675 | 0.706 | 3.7 | 0/10 |
| validation | hybrid_rrf | 0.900 | 0.900 | 0.783 | 0.813 | 9.5 | 0/10 |
...
- development/hybrid_rrf/ac-001: AC-200的额定排气量和压力是多少？；相关排名 [2]
- development/hybrid_rrf/ac-008: E301与E302分别表示哪个过滤器堵塞？；相关排名 [5]
- development/hybrid_rrf/ac-013: 机器一直加载，车间压力却升不上去，会有哪些原因？；相关排名 [5]
...
- validation/hybrid_rrf/ac-027: CASE-AC-001最后定位到的故障原因是什么？；相关排名 [3]
